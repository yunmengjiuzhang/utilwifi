package com.github.wangfeixixi.utilwifi;
...
import wangfei.wifi.IEsptouchTask;
import wangfei.wifi.task.__IEsptouchTask;
...
public class EsptouchDemoActivity extends Activity implements OnClickListener {
    ...
    private void initview() {
        ...
        Integer[] spinnerItemsInteger = new Integer[]{0, 1, 2, 3, 4, 5};
